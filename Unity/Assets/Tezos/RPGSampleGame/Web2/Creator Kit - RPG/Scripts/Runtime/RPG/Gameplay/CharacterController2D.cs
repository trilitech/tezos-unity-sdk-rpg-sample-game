...
namespace RPGM.Gameplay
{
    ...
    public class CharacterController2D : MonoBehaviour
    {
        ...
        void UpdateAnimator(Vector3 direction)
        {
            if (animator)
            {
                int xValue = direction.x < 0 ? -1 : direction.x > 0 ? 1 : 0;
                int yValue = direction.y < 0 ? 1 : direction.y > 0 ? -1 : 0;
                ...
                animator.SetInteger("WalkX", xValue);
                animator.SetInteger("WalkY", yValue );
            }
        }
